    ...
    <div style={{ background: '#f0eaff', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <Link href="/deposit" style={{ background: '#6c3fc5', color: '#fff', padding: '12px 24px', borderRadius: '10px', textDecoration: 'none', display: 'inline-block', margin: '5px' }}>
            + Naya Card Deposit
          </Link>
          <Link href="/winners" style={{ background: '#ffd700', color: '#333', padding: '12px 24px', borderRadius: '10px', textDecoration: 'none', display: 'inline-block', margin: '5px' }}>
            🏆 Winners
          </Link>
        </div>
              ...
              {prizes.map(prize => (
                ...
                >
                  <div style={{ background: '#fff', borderRadius: '12px', padding: '12px', textAlign: 'center', boxShadow: '0 2px 10px rgba(108,63,197,0.12)', border: '2px solid #e8d5ff', cursor: 'pointer' }}>
                    ...
                    <div style={{ color: '#6c3fc5', fontSize: '0.8em', marginTop: '5px' }}>
                      👆 Click karein
                    </div>
                  </div>
                </Link>
